...
public class Constants {
	...
	public static final int DECK_STARTING_ID = 1;
	...
	public static final String BUNNIES_PATH = "src/gui/bunnies.jpg";

	public static final int PNL_MAIN_WIDTH = 960;
	public static final int PNL_MAIN_HEIGHT = 1024;
